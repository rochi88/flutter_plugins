import 'package:device_preview/src/frame/device_frame.dart';
...
class _VirtualKeyboard extends StatelessWidget {
  const _VirtualKeyboard({double? height}) : height = height ?? minHeight;
  ...
  Widget _row(List<Widget> children) {
    return Padding(
      padding: const EdgeInsets.only(top: spacing, left: spacing),
